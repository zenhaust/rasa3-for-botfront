...
class BotfrontFileImporter(TrainingDataImporter):
    def __init__(
        ...
        if config_file:
            ...
            for file in config_file:
                ...
                # FIXME djypanda: core_config is lang discriminated
                if not self.core_config or lang == "zh":
    ...
    def get_nlu_config(self, languages=True) -> Dict:
    ...
    def get_nlu_data(self, languages=True) -> Dict[Text, TrainingData]:
        language = None
